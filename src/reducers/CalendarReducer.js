const INITIAL_STATE = {
  calendar: [
    {date: "01-01-2019", day: 'Break', events: []},
    {date: "02-01-2019", day: 'Break', events: []},
    {date: "03-01-2019", day: 'Break', events: []},
    {date: "04-01-2019", day: 'Break', events: []},
    
    {date: "05-01-2019", day: 'Weekend', events: []},
    ...
    {date: "12-01-2019", day: 'Weekend', events: []},
    {date: "13-01-2019", day: 'Weekend', events: []},

    {date: "14-01-2019", day: 'Day 2', events: []},
    {date: "15-01-2019", day: 'Day 1', events: []},
    {date: "16-01-2019", day: 'Day 2', events: []},
    ...
    {date: "26-01-2019", day: 'Weekend', events: []},
    {date: "27-01-2019", day: 'Weekend', events: []},
    
    {date: "28-01-2019", day: 'Day Off', events: ['PRO-D DAY']},
    {date: "29-01-2019", day: 'Day 1', events: ['Rotation #3 —— 2143']},
    {date: "30-01-2019", day: 'Day 2', events: []},
    {date: "31-01-2019", day: 'Day 1', events: []},
    {date: "01-02-2019", day: 'Day 2', events: []},
    
    {date: "02-02-2019", day: 'Weekend', events: []},
    {date: "03-02-2019", day: 'Weekend', events: []},
    ...
    {date: "09-02-2019", day: 'Weekend', events: []},
    {date: "10-02-2019", day: 'Weekend', events: []},

    {date: "11-02-2019", day: 'Day 2', events: []},
    {date: "12-02-2019", day: 'Day 1', events: []},
    {date: "13-02-2019", day: 'Day 2', events: ['American Math Competition 12B']},
    {date: "14-02-2019", day: 'Day 1', events: []},
    {date: "15-02-2019", day: 'Day Off', events: ['PRO-D DAY']},

    {date: "16-02-2019", day: 'Weekend', events: []},
    {date: "17-02-2019", day: 'Weekend', events: []},
    ...
    {date: "21-02-2019", day: 'Day 2', events: []},
    {date: "22-02-2019", day: 'Day 1', events: []},

    {date: "23-02-2019", day: 'Weekend', events: []},
    {date: "24-02-2019", day: 'Weekend', events: []},

    {date: "25-02-2019", day: 'Day 2', events: []},
    {date: "26-02-2019", day: 'Day 1', events: []},
    {date: "27-02-2019", day: 'Day 2', events: ['PCF Math Competition']},
    {date: "28-02-2019", day: 'Day 1', events: ['Jazz Caberet 7:00 PM in Cafeteria']},
    {date: "01-03-2019", day: 'Day 2', events: []},
    
    {date: "02-03-2019", day: 'Weekend', events: []},
    {date: "03-03-2019", day: 'Weekend', events: []},

    {date: "04-03-2019", day: 'Day 1', events: []},
    {date: "05-03-2019", day: 'Day 2', events: ['Collab / Flex', 'Term 2 Ends']},
    {date: "06-03-2019", day: 'Day 1', events: []},
    {date: "07-03-2019", day: 'Day 2', events: []},
    {date: "08-03-2019", day: 'Day 1', events: []},

    {date: "09-03-2019", day: 'Weekend', events: []},
    {date: "10-03-2019", day: 'Weekend', events: []},
    ...
    {date: "17-03-2019", day: 'Weekend', events: []},
    ...
    {date: "23-03-2019", day: 'Weekend', events: []},
    {date: "24-03-2019", day: 'Weekend', events: []},
    ...
    {date: "30-03-2019", day: 'Weekend', events: []},
    {date: "31-03-2019", day: 'Weekend', events: []},

    {date: "01-04-2019", day: 'Day 1', events: ['School Re-Opens']},
    {date: "02-04-2019", day: 'Day 2', events: []},
    {date: "03-04-2019", day: 'Day 1', events: []},
    {date: "04-04-2019", day: 'Day 2', events: ['Euclid Math Competition']},
    {date: "05-04-2019", day: 'Day 1', events: []},

    {date: "06-04-2019", day: 'Weekend', events: []},
    ...
    {date: "13-04-2019", day: 'Weekend', events: []},
    {date: "14-04-2019", day: 'Weekend', events: []},

    {date: "15-04-2019", day: 'Day 1', events: []},
    {date: "16-04-2019", day: 'Day 2', events: []},
    ...
    {date: "20-04-2019", day: 'Weekend', events: []},
    {date: "21-04-2019", day: 'Weekend', events: []},

    {date: "22-04-2019", day: 'Day Off', events: ['Holiday: Easter Friday']},
    {date: "23-04-2019", day: 'Day 1', events: []},
    {date: "24-04-2019", day: 'Day 2', events: []},
    {date: "25-04-2019", day: 'Day 1', events: []},
    {date: "26-04-2019", day: 'Day 2', events: ['Exec Council Speeches at Lunch in Auditorium', 'Grade Rep Application Due']},
    
    {date: "27-04-2019", day: 'Weekend', events: []},
    {date: "28-04-2019", day: 'Weekend', events: []},

    {date: "29-04-2019", day: 'Day Off', events: ['PRO-D DAY']},
    {date: "30-04-2019", day: 'Day 1', events: []},
    ...
    {date: "03-05-2019", day: 'Day 2', events: []},

    {date: "04-05-2019", day: 'Weekend', events: []},
    {date: "05-05-2019", day: 'Weekend', events: []},
    ...
    {date: "13-05-2019", day: 'Day 2', events: []},
    {date: "14-05-2019", day: 'Day 1', events: []},
    {date: "15-05-2019", day: 'Day 2', events: []},
    {date: "16-05-2019", day: 'Day 1', events: ['GAUSS Math Competition']},
    {date: "17-05-2019", day: 'Day Off', events: ['PRO-D DAY']},

    {date: "18-05-2019", day: 'Weekend', events: []},
    {date: "19-05-2019", day: 'Weekend', events: []},

    {date: "20-05-2019", day: 'Day Off', events: ['Holiday: Victoria Day']},
    {date: "21-05-2019", day: 'Day 2', events: []},
    {date: "22-05-2019", day: 'Day 1', events: ['Dance Show 1:30 PM in Auditorium', 'Spring Play Matinee 7:00 PM in Auditorium']},
    {date: "23-05-2019", day: 'Day 2', events: []},
    {date: "24-05-2019", day: 'Day 1', events: ['Last Day IB Exams', 'Altered Schedule', 'Spring Carnival']},

    {date: "25-05-2019", day: 'Weekend', events: []},
    {date: "26-05-2019", day: 'Weekend', events: []},

    {date: "27-05-2019", day: 'Day 2', events: []},
    {date: "28-05-2019", day: 'Day 1', events: []},
    ...
    {date: "01-06-2019", day: 'Weekend', events: []},
    {date: "02-06-2019", day: 'Weekend', events: []},

    {date: "03-06-2019", day: 'Day 1', events: []},
    {date: "04-06-2019", day: 'Day 2', events: []},
    ...
    {date: "07-06-2019", day: 'Day 1', events: []},

    {date: "08-06-2019", day: 'Weekend', events: []},
    {date: "09-06-2019", day: 'Weekend', events: []},
    
    {date: "10-06-2019", day: 'Day 2', events: []},
    {date: "11-06-2019", day: 'Day 1', events: ['Athletic Banguet']},
    {date: "12-06-2019", day: 'Day 2', events: []},
    {date: "13-06-2019", day: 'Day 1', events: ['Grad Dinner / Dance']},
    {date: "14-06-2019", day: 'Day 2', events: []},

    {date: "15-06-2019", day: 'Weekend', events: []},
    {date: "16-06-2019", day: 'Weekend', events: []},

    {date: "17-06-2019", day: 'Day 1', events: []},

const INITIAL_STATE = {
  ...
  block1_3: {
    ...
    courseTeacher: 'Mr. Benson', courseColor: '#9C27B0', courseNotes: ''
  },
  block1_4: {
    courseBlock: '1 - 4', courseName: 'English 12', courseRoom: 'Rm. 203', 
    courseTeacher: 'Mr. Hauck', courseColor: '#8BC34A', courseNotes: ''
  },
  block2_1: {
    courseBlock: '2 - 1', courseName: 'Programming 12', courseRoom: 'Rm. 102', 
    courseTeacher: 'Mrs. Braaten', courseColor: '#673AB7', courseNotes: ''
  },
  block2_2: {
    courseBlock: '2 - 2', courseName: 'Draf & Design 11', courseRoom: 'Rm. 215', 
    courseTeacher: 'Mr. Olson', courseColor: '#FFC107', courseNotes: ''
  },
  block2_3: {
    courseBlock: '2 - 3', courseName: 'Painting 11', courseRoom: 'Rm. 308', 
    courseTeacher: 'Mr. Lawrence', courseColor: '#E91E63', courseNotes: ''
  },
  block2_4: {
    courseBlock: '2 - 4', courseName: 'Business 12', courseRoom: 'Rm. 100', 
    courseTeacher: 'Mr. Kam', courseColor: '#00BCD4', courseNotes: ''
  }
};
